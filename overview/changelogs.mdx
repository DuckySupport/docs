...
As of v1.6.0 Stable, we're moving our detailed changelogs from Discord to our documentation page for better formatting and a much larger character limit.
...
<Update label="v1.6.0 Stable" description="January 31, 2026">
    **The first update of 2026 is here!** We've been working on v1.6.0 Stable for a while now, and after weeks of testing, development, and even more testing, it's finally ready.
    ...
    Phew, that took a long time to write. If you need support, would like to make a suggestion, or report a bug, hop into [**Ducky's Pond**](https://duckybot.xyz/support).
