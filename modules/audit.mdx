---
title: "Audit Logging"
description: "Learn about Ducky's Audit Logging module and how to configure it."
tag: "NEW"
---
...
<Steps>
  <Step title="Audit Logs Channel" titleSize="h2">
    The **Audit Logs Channel** is where all configured audit log types will be sent.
  </Step>
  <Step title="Audit Log Types" titleSize="h2">
    You can select which audit log types you would like Ducky to log.

    Each audit log type corresponds to a specific action or event in your server.
    ...
    <Note>
      Consider selecting only the audit log types you need to prevent cluttering.
    </Note>
    <Warning>
      To prevent harsh ratelimits, Ducky utilizes **Webhooks** to send audit logs. Be sure to whitelist your audit log channel for embed spam from security bots such as **Wick**.
    </Warning>
  </Step>
</Steps>