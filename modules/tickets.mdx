...
<Steps>
  <Step title="Create Ticket Panel" iconType="regular" stepNumber={1} titleSize="h2">
    ...
    <Warning>
      Only one ticket panel can be created; upgrade to Ducky Plus+ to make up to five.
    </Warning>
  </Step>
  ...
  <Step title="Ticket Subjects" titleSize="h2">
    ...
    <Steps>
      ...
      <Step title="Support Roles" icon="wrench" titleSize="h3">
        ...
        <Info>
          Members with "Administrator" permissions can view all channels, regardless of Support Roles.
        </Info>
      </Step>
      ...
      <Step title="Blacklisted Roles" icon="x" titleSize="h3">
        ...
        <Info>
          Blacklisted Roles are not required.
        </Info>
      </Step>
