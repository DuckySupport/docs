...
This page provides the essential configuration options for Ducky's **Ticket Module**, which gives you full control over tickets within Ducky. Allowing members to contact support staff for any issues or concerns you may have. To confirgure and setup the tickets module, use the `/setup` command and navigate to the **Tickets** page.
  ...
  <Step title="Ticket Subjects" titleSize="h2">
    ...
    <Steps>
      ...
      <Step title="Emoji" icon="face-smile" titleSize="h3">
        ...
        <Info>
          The emoji selection is not required.
        </Info>
        <Note>
      ...
      <Step title="Category" icon="hashtag" titleSize="h3">
        ...
        <Info>
          The category is not required, the channel will be placed in no category, and be at the top of the channel list.
        </Info>
      </Step>
      <Step title="Transcripts Channel" icon="ticket" titleSize="h3">
        The transcripts channel is where closed tickets are logged, and transcripts are kept. A transcript contains all messages said inside of the ticket. The transcript is accessible using the .txt file provided, or by clicking "Web Transcript"
      </Step>
    </Steps>
  </Step>
</Steps>