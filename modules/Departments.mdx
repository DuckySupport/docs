...
<Steps>
  <Step title="Linking Departments" titleSize="h2">
    <Note>
      To link department servers, it will greatly help you to first enable [developer mode](https://docs.duckybot.xyz/misc/devmode) on Discord.
    </Note>
  ...
  <Step title="Features of The Departments Module" titleSize="h2">
    <AccordionGroup>
      ...
      <Accordion title="Linked Roles" icon="link">
        <Note>
          To link roles, it will greatly help you to first enable [developer mode](https://docs.duckybot.xyz/misc/devmode) on Discord.
        </Note>
