...
<Accordion title="ERLC Staff Roles" icon="Hammer">
  - `/erlc server:` Members of the configured **ERLC Staff** permission roles are authorized to view general information on the linked ER:LC server.
  - `/erlc players:` Members of the configured **ERLC Staff** permission roles are authorized to view the live playercount on the linked ER:LC server.
  ...
  - `/erlc tempban:` Members of the configured **ERLC Staff** permission roles are authorized to temporarily ban a player.
  - `/erlc untempban:`  Members of the configured **ERLC Staff** permission roles are authorized to remove a temporary ban on a player.
  ...
  - `/bolo pending:` Members of the configured **ERLC Staff** permission roles are authorized to view the pending ban bolos.
...
<Accordion title="Manage Server Permissions" icon="gear">
  > _Manage Server Permission bypasses all other permissions, if you have Manage Server Permission you do not need the other permission roles\!_

  - `/updatemembers:` Members of the configured **Manage Server** permission roles are authorized to update all members to your configuration, including verification and join roles.


  - `/giveaway create:` Members of the configured **Manage Server** permission roles are authorized to create a giveaway.
  - `/embed:` Members of the configured **Manage Server** permission roles are authorized to open the Embed Editor and create an embed.
  - `/emoji clone:` Members of the configured **Manage Server** permission roles are authorized to clone an emoji.
  - `/emoiji view:` Members of the configured **Manage Server** permission roles are authorized to view information about an emoji.
  - `/setup:` Members of the configured **Manage Server** permission roles are authorized to setup/configure Ducky in the server.
  - `/prefix:` Members of the configured **Manage Server** permission roles are authorized to view and edit the current server prefix for Ducky.
  - `/automations create:` Members of the configured **Manage Server** permission roles are authorized to create an automation.
  - `/automations list:` Members of the configured **Manage Server** permission roles are authorized to view all automations in a server.
  - `/automations delete:` Members of the configured **Manage Server** permission roles are authorized to delete an automation.
  - `/automations edit:` Members of the configured **Manage Server** permission roles are authorized to edit an automation.
  - `/syncbans:` Members of the configured **Manage Server** permission roles are authorized to sync bans between the ERLC server and Discord server.
  - `/balance:` Members of the configured **Manage Server** permission roles are authorized to edit and reset a user's economy balance.
</Accordion>