---
title: "Permissions"
description: "Learn what each role-based permission level has access to via Ducky."
---
...
<Accordion title="Discord Moderator Roles" icon="hammer">
  ...
  - **`/role`:** Members of the configured **Discord Moderator** permission roles are authorized to view any given role's information, add a role (which they have access to, automatically determined based on member/role hierarchy) to another member, and remove a role (which they have access to, automatically determined based on member/role hierarchy) from a member.
